...
def download(
    ...
    wandb_project: str = "audio2dataset",
    ...
    """Download is the main entry point of audio2dataset, it uses multiple processes and download multiple files"""
